...
export function lintWorkflowDocument(filePath: string, content: string, workflow: WorkflowMap): Finding[] {
...
function asRecord(value: unknown): WorkflowMap | undefined {
  return value && typeof value === 'object' && !Array.isArray(value)
    ? (value as WorkflowMap)
    : undefined;
}
